  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.searchBar}>
        ...
        <TextInput placeholder='Trữ tình, nhạc thiếu nhi ...' style={styles.input} />
        ...
        <ScrollView>
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              <TouchableOpacity style={{ margin: 10, marginLeft: 20,justifyContent:'center',alignItems:'center' }}>
                <Image source={item.image} style={{ width: 155, height: 100, borderRadius: 10 }} />
                <Text style={{position:'absolute',fontWeight:'700',fontSize:13,color:'white'}}>{item.category}</Text>
              </TouchableOpacity>
