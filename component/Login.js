    ...
    <View style={styles.container}>
        ...
        <Text style = {{fontSize:45 ,color:'#FFF',marginLeft:-90}}>mp3</Text>
            ...
            <TouchableOpacity style={styles.customButton} onPress={()=>{navigation.navigate('KhamPha')}}>
             ...
             <Text style={{fontSize:13,color:'white',paddingTop:20}}>Bạn chưa là thành viên?
             <TouchableOpacity> <Text style={[styles.text, styles.customText1, { color: '#4790FD' }]}> Hãy đăng ký</Text>
             </TouchableOpacity>
